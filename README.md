# Awesome Deep Learning University Assignments
...
- [Awesome Deep Learning University Assignments](#awesome-deep-learning-university-assignments)
  ...
  - [Convolutional Neural Networks (CNN)](#convolutional-neural-networks-cnn)
    - [Berkeley 196-126 HW 2A](#berkeley-196-126-hw-2a)
  ...
  - [Generative Adversarial Networks (GAN)](#generative-adversarial-networks-gan)
    - [CMU 16-726 Assignment 3 GAN Part](#cmu-16-726-assignment-3-gan-part)
...
| Rating | Level | Description |
|:------:|-------|-------------|
| ⭐☆☆☆☆ | **Not Useful** | No coding required or just parameter tweaking |
| ⭐⭐☆☆☆ | **Somewhat Useful** | Guided implementation, limited learning |
| ⭐⭐⭐☆☆ | **Useful** | Good balance of guidance and concept understanding |
| ⭐⭐⭐⭐☆ | **Highly Useful** | Deep conceptual learning with meaningful implementation |
| ⭐⭐⭐⭐⭐ | **Extremely Useful** | Comprehensive understanding, industry-relevant skills |
...
### [Berkeley 196-126 HW 2A]()
Implementation of CNNs for image classification. The assignment walks through building a basic FCNN, CNN, and ResNet block and it demonstrates how CNNs achieve better performance (with fewer parameters comparing CNN and FCNN) on CIFAR-10. The implementation covers convolutional layers and residual connections while exploring hyperparameter optimization and data augmentation techniques to reach 85% validation accuracy.
...
![alt text](training_plots/resnet.png)
...
### [CMU 16-726 Assignment 3 GAN Part](https://learning-image-synthesis.github.io/sp25/assignments/hw3)
In this assignment we implement DCGAN and CycleGAN for generating cat images for DCGAN part, most of things are already implemented. The "tricky" part is to handle the model dimensions.
...
## TODO
1. Improve the descriptions
2. Add training plots?
3. Add usefulness of assignment
4. Add more models
